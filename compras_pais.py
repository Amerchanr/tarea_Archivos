...
def agregar_comp():
    ...
    for i in range(datos_dic):
        clave = input('Ingrese el pais donde hizo la compra: ')
        valor = None
        bolean = True
        while bolean:
            try:
